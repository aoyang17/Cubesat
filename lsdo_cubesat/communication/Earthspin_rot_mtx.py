...
class EarthspinRotationMtx(ExplicitComponent):
    ...
    def setup(self):
        ...
        self.add_input('q_E', shape=(4, num_times), units=None,
    ...
    def compute(self,inputs,outputs):
        ...
        outputs['Rot_ECI_EF'][0, 0, :] = 1 - 2 * q_E[2, :]**2 -2 * q_E[3,:]**2
        outputs['Rot_ECI_EF'][0, 1, :] = 2 * q_E[1, :] * q_E[2, :] - 2 * q_E[3, :] * q_E[0, :]
        outputs['Rot_ECI_EF'][0, 2, :] = 2 * q_E[1, :] * q_E[3, :] + 2 * q_E[2, :] * q_E[0, :]
        outputs['Rot_ECI_EF'][1, 0, :] = 2 * q_E[1, :] * q_E[2, :] + 2 * q_E[3, :] * q_E[0, :]
        outputs['Rot_ECI_EF'][1, 1, :] = 1 - 2 * q_E[1, :]**2 - 2 * q_E[3, :]**2
        outputs['Rot_ECI_EF'][1, 2, :] = 2 * q_E[2, :] * q_E[3, :] - 2 * q_E[1, :] * q_E[0, :]
        outputs['Rot_ECI_EF'][2, 0, :] = 2 * q_E[1, :] * q_E[3, :] - 2 * q_E[2, :] * q_E[0, :]
        outputs['Rot_ECI_EF'][2, 1, :] = 2 * q_E[2, :] * q_E[3, :] + 2 * q_E[1, :] * q_E[0, :]
        outputs['Rot_ECI_EF'][2, 2, :] = 1 - 2 * q_E[1, :]**2 - 2 * q_E[2, :]**2 
