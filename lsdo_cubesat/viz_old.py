...
class Viz(BaseViz):
    ...
    def plot(self, data_dict_list, ind, video=False):
        ...
        for cubesat_name in cubesat_names:
            ...
            mask_vec = data_dict_list[ind]['mask_vec']
            ...
            KS_Download_rate = data_dict_list[ind][
        ...
        total_data_download = data_dict_list[ind]['total_data_downloaded']
        total_propellant_used = data_dict_list[ind]['total_propellant_used']
        observation_dot = data_dict_list[ind]['observation_dot']
        ...
        with self.get_frame(1)[0, 0:3] as ax:
            ...
            data = data_dict_list[ind]['detector_cubesat_group.Data']
            # print(data.shape)
        ...
        with self.get_frame(1)[1, 0:3] as ax:
            ...
            CommLOS = data_dict_list[ind][
                '{}_cubesat_group.UCSD_comm_group.CommLOS'.format(
                    cubesat_name)]
        ...
        with self.get_frame(1)[3, 12:15] as ax:
            ...
            if video:
                ax.set_ylim(
                    self.get_limits(
                        'detector_cubesat_group.UCSD_comm_group.P_comm',
                        lower_margin=0.1,
                        upper_margin=0.1,
                    ))
            ax.set_xlabel('num_times')
        ...
        with self.get_frame(1)[4, 0:3] as ax:
            ...
            UCSD_data_rate = data_dict_list[ind][
        ...
        with self.get_frame(1)[4, 4:7] as ax:
            ...
            UIUC_data_rate = data_dict_list[ind][
        ...
        with self.get_frame(1)[4, 8:11] as ax:
            ...
            Georgia_data_rate = data_dict_list[ind][
        ...
        with self.get_frame(1)[4, 12:15] as ax:
            ...
            Montana_data_rate = data_dict_list[ind][
